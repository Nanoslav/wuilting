...
export default function Login() {
    ...
    return (
        <div className="relative flex flex-col justify-center h-screen overflow-hidden">
            <div className="p-0.5/10 lg:p-0.25/10 m-auto rounded-md shadow-md w-9/10 lg:w-4/10 bg-base-100">
                {/*<h2 className="mb-1 text-2xl lg:text-2 font-semibold text-center text-teal-300">💫 Wuilting 💫</h2>*/}
                <h1 className="mb-5 font-semibold text-center text-10 lg:text-3">Login</h1>
                <div className='flex flex-col gap-[1dvw]'>
                    <button title='Login with Discord' className="btn w-full h-[5dvw] lg:h-[3dvw] lg:text-1" type={'button'}
                            onClick={() => Login('discord')}>
                        <FontAwesomeIcon icon={faDiscord}/> Login with Discord
                    </button>
                    <button title='Login with Google' className="btn w-full h-[5dvw] lg:h-[3dvw] lg:text-1" type={'button'}
